defmodule AlpacaProxyWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AlpacaProxyWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AlpacaProxyWeb.Gettext, "errors", msg, opts)
    end
  end
